...
exports.http.interceptors.request.use(function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var accessUser;
    return __generator(this, function (_a) {
        accessUser = JSON.parse(localStorage.getItem('access_token'));
        if (accessUser) {
